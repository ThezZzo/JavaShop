...
import com.example.JavaShop.util.JwtRequestFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public WebSecurityConfig(@Lazy UserDetailsService jwtUserDetailsService, JwtRequestFilter jwtRequestFilter) {
